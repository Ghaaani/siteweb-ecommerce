                                                ...
                                                <table class="text-center">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            <td class="product-thumbnail">
                                                                <div class="pro-thumbnail-img">
                                                                    <img src="{{('client/img/cart/1.jpg' )}}" alt="" />
                                                                </div>
                                                        ...
                                                        <tr>
                                                            <td class="product-thumbnail">
                                                                <div class="pro-thumbnail-img">
                                                                    <img src="{{('client/img/cart/2.jpg' )}}" alt="" />
                                                                </div>
                                                                <div class="pro-thumbnail-info text-start">
                                                                    <h6 class="product-title-2">
                                                                        <a href="#">dummy product name</a>
                                                        ...
                                                        <tr>
                                                            <td class="product-thumbnail">
                                                                <div class="pro-thumbnail-img">
                                                                    <img src="{{('client/img/cart/3.jpg' )}}" alt="" />
                                                                </div>
                                                                <div class="pro-thumbnail-info text-start">
                                                                    <h6 class="product-title-2">
                                                                        <a href="#">dummy product name</a>
                                                                ...
                                                                <div id="collapseThree" class="panel-collapse collapse" data-bs-parent="#accordion">
                                                                    <div class="payment-content">
                                                                        ...
                                                                        <ul class="payent-type mt-10">
                                                                            <li><a href="#"><img src="{{('client/img/payment/1.png')}}" alt=""></a></li>
                                                                            <li><a href="#"><img src="{{('client/img/payment/2.png')}}" alt=""></a></li>
                                                                            <li><a href="#"><img src="{{('client/img/payment/3.png')}}" alt=""></a></li>
                                                                            <li><a href="#"><img src="{{('client/img/payment/4.png')}}" alt=""></a></li>
                                                                        </ul>
                                                                    </div>
                                                                </div>
                                                            </div>
